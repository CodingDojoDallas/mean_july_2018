...
const UserSchema = new mongoose.Schema({
    ...
    password: { type: String, required: [true, "Password is required"], minlength:7 },
    birthday: { type: String, required: [true, "Date is required"] }
}, { timestamps: true })
...
app.post('/registration', function (req, res) {
    ...
    console.log("Now find a user email!")
    User.findOne({ email: req.body.email }, function (err, user) {
